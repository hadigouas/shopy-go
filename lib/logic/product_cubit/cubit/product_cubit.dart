...
class ProductCubit extends Cubit<ProductState> {
  ...
  Future<ProductModule?> fetchProduct(String documentId) async {
    try {
      ...
      if (userinfo.exists) {
        return ProductModule(
          productImage: userinfo.get('image'),
          productQuantity: userinfo.get('quantity'),
          productId: documentId,
          productTitle: userinfo.get('title'),
          productPrice: userinfo.get('price'),
          productCategory: userinfo.get('catigory'),
          productDescription: userinfo.get('discription'),
        );
      } else {
